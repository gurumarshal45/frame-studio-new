...
if (['/', '/admin', '/portfolio'].includes(path)) {
  ...
  const contactFloat = `<div class="contact-float" aria-label="Quick contact"><a class="float-action whatsapp" href="https://wa.me/918790042094" target="_blank" rel="noopener" aria-label="Chat on WhatsApp" title="WhatsApp"><svg aria-hidden="true" viewBox="0 0 24 24"><path d="M20.5 3.5A11.8 11.8 0 0 0 12.1 0C5.5 0 .2 5.3.2 11.9c0 2.1.6 4.2 1.6 6L0 24l6.3-1.7a12 12 0 0 0 5.8 1.5h.1c6.5 0 11.8-5.3 11.8-11.9 0-3.2-1.2-6.2-3.5-8.4Zm-8.3 18.3h-.1c-1.8 0-3.5-.5-5-1.4l-.4-.2-3.7 1 1-3.6-.2-.4a9.8 9.8 0 0 1-1.5-5.3A9.8 9.8 0 0 1 12.2 2c2.6 0 5.1 1 7 2.9a9.8 9.8 0 0 1-7 16.9Zm5.4-7.3c-.3-.2-1.8-.9-2.1-1-.3-.1-.5-.2-.7.2l-.9 1.1c-.2.2-.3.2-.6.1a8 8 0 0 1-2.5-1.5 9.4 9.4 0 0 1-1.7-2.1c-.2-.3 0-.5.1-.6l.5-.5.3-.5c.1-.2.1-.4 0-.5l-1-2.4c-.3-.6-.6-.5-.8-.5h-.7c-.2 0-.6.1-.9.4-.3.3-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.4 3.7 5.9 5.2.8.4 1.5.6 2 .7.8.3 1.6.2 2.2.1.7-.1 1.8-.7 2-1.4.3-.7.3-1.3.2-1.4-.1-.2-.3-.3-.6-.4Z"/></svg></a><a class="float-action phone" href="tel:+918790042094" aria-label="Call Frame Studio" title="Call"><svg aria-hidden="true" viewBox="0 0 24 24"><path d="M6.6 10.8a15.5 15.5 0 0 0 6.6 6.6l2.2-2.2c.3-.3.7-.4 1.1-.2 1.2.4 2.5.6 3.8.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1C10.8 21 3 13.2 3 3.7c0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.6.6 3.8.1.4 0 .8-.3 1.1l-2.2 2.2Z"/></svg></a><a class="float-action map" href="https://www.google.com/maps/search/?api=1&amp;query=Frame+Studio+Hyderabad" target="_blank" rel="noopener" aria-label="Find Frame Studio on Google Maps" title="Map"><svg aria-hidden="true" viewBox="0 0 24 24"><path d="M12 1.8a8 8 0 0 0-8 8c0 5.8 8 12.4 8 12.4s8-6.6 8-12.4a8 8 0 0 0-8-8Zm0 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6Z"/></svg></a></div>`;
  document.body.innerHTML = `${nav}<main class="inner-main"><section class="page-hero"><img src="${media}${page.image}" alt=""><div></div><p>${page.label}</p><h1>${page.title}</h1></section>${page.body}</main>${footer}${contactFloat}`;
